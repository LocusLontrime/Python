...
def run(argv):
    ServerHTTPHandler.contest, ServerHTTPHandler.participants, ServerHTTPHandler.login_submissions = read_input(
        open(argv[1]))  # input

    print(f'pars: {ServerHTTPHandler.contest, ServerHTTPHandler.participants, ServerHTTPHandler.login_submissions}')
