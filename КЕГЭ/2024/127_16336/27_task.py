...
arr_A = get_arr(f'27_A_16336.txt')
arr_B = get_arr(f'27_B_16336.txt')

print(f'min_costs test ex -> {compute_min_costs(test_ex)}')
print(f'res: {eval(f"1 * 7 + 0 * 19 + 1 * 8 + 2 * 20 + 3 * 5 + 2 * 13")}')

print(f'min costs file A -> {compute_min_costs(arr_A)}')
print(f'min costs file B -> {compute_min_costs(arr_B)}')                              # 36 366 98 989 98989 LL
